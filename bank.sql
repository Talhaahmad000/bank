...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2024 at 06:42 AM
...
CREATE TABLE customer (
  ...
  CONSTRAINTS FK_BRANCH_CODE FOREIGN KEY (BRANCH_CODE ) REFERENCES BRANCH (BRANCH_CODE) 
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE transaction (
  ...
  CONSTRAINTS FK_account_no FOREIGN KEY (ACCOUNT_NO) REFERENCES ACCOUNT (ACCOUNT_NO) 
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
